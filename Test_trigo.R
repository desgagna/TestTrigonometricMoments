# ====================================================================================
# Script : test_trigo.R
# Object : programming code for the article: A large class of powerful goodness-of-fit 
#                                             tests based on first trigonometric moments
# Author : Alain Desgagne 
# Date   : 2005-07-18
# ====================================================================================

# ====================================================================================
# All necessary R functions and packages
# ====================================================================================

rm(list=ls())
setwd("C:/Users/desgagne_a/Documents/4Recherche/Articles/Tests LK")
source(file = 'Trigo_tests_functions.R', echo = TRUE)
options(digits = 10)   
...
#library(MASS) # ginv Moore-Penrose generalized inverse of a matrix X
#library(pracma)# Si and Ci functions
...
# APD
mu <- 2.3; sigma <- 1.8; lambda <- 1.5; alpha <- 0.4; rho <- 2 
...
left.bound <- -Inf; right.bound <- Inf; quant <- mu + 1.4
...
mle <- function(x)  ML.EPD(x, lambda)
mle <- function(x)  ML.EPD(x)
mm <- function(x)  MM.EPD(x, lambda)
left.bound <- -Inf; right.bound <- Inf; theta <- c(lambda, mu, sigma); quant <- mu + 1.4
test <- function(x)  EPD.test.ML(x)
test <- function(x)  EPD.test.ML(x, lambda)
test <- function(x)  EPD.test.ML(x, lambda, mu = mu) 
test <- function(x)  EPD.test.ML(x, lambda, sigma = sigma)
test <- function(x)  EPD.test.ML(x, lambda, mu = mu, sigma = sigma)
...
mle <- function(x)  ML.Laplace(x)
mm <- function(x)  MM.Laplace(x)
left.bound <- -Inf; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
test <- function(x)  Laplace.test.ML(x)
...
mle <- function(x)  ML.exp.gamma(x)
left.bound <- -Inf; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
test <- function(x)  exp.gamma.test.ML(x)
test <- function(x)  exp.gamma.test.ML(x, lambda)
test <- function(x)  exp.gamma.test.ML(x, lambda, mu = mu)
test <- function(x)  exp.gamma.test.ML(x, lambda, sigma = sigma)
...
mle <- function(x)  ML.exp.Weibull(x)
left.bound <- -Inf; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
gen <- function(n) rexp.Weibull(n, mu, sigma) 
...
mle <- function(x)  ML.logistic(x)
mm <- function(x)  MM.logistic(x)
left.bound <- -Inf; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
test <- function(x) logistic.test.ML(x)
test <- function(x) logistic.test.MM(x)

# Student's-t 
mu <- 2.3; sigma <- 1.8; lambda <- .7
...
mle  <- function(x) ML.Student(x)
mle  <- function(x) ML.Student(x, lambda)
mm  <- function(x) MM.Student(x, lambda)
left.bound <- -Inf; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
...
# log-EPD
mu <- 2.3; sigma <- 1.8; lambda <- 2.5
dens <- function(x) dlogEPD(x, lambda, mu, sigma)
cdf  <- function(x) plogEPD(x, lambda, mu, sigma)
gen <- function(n) rlogEPD(n, mu, sigma, lambda) 
mle <- function(x)  ML.logEPD(x)
mle <- function(x)  ML.logEPD(x, lambda)
mm <- function(x)  MM.logEPD(x, lambda)
left.bound <- 0; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
gen <- function(n) rlogEPD(n, mu, sigma, lambda) 
test <- function(x)  logEPD.test.ML(x)
test <- function(x)  logEPD.test.ML(x, lambda)
...
mle <- function(x)  ML.logLaplace(x)
mm <- function(x)  MM.logLaplace(x)
left.bound <- 0; right.bound <- Inf; theta <- c(mu, sigma); quant <- mu + 1.4
...
mle <- function(x)  ML.GG(x)
left.bound <- 0; right.bound <- Inf; theta <- c(lambda, beta, rho); quant <- beta * 1.5
test <- function(x) GG.test.ML(x)
test <- function(x) GG.test.ML(x, lambda, beta = 2.3)
test <- function(x) GG.test.ML(x, lambda, rho = 1.8)
test <- function(x) GG.test.ML(x, lambda, beta = 2.3, rho = 1.8)
...
mle <- function(x)  ML.Weibull(x)
left.bound <- 0; right.bound <- Inf; theta <- c(beta, rho); quant <- beta * 1.5
...
mle <- function(x)  ML.Gompertz(x) 
left.bound <- 0; right.bound <- Inf; theta <- c(beta, rho); quant <- .4
...
mle <- function(x)  ML.loglogistic(x)
left.bound <- 0; right.bound <- Inf; theta <- c(beta, rho); quant <- beta * 1.5
...
mle <- function(x)  ML.gamma(x)
left.bound <- 0; right.bound <- Inf; theta <- c(alpha, beta); quant <- 3
test <- function(x)  gamma.test.ML(x)
test <- function(x)  gamma.test.ML(x, alpha = 2.3)
test <- function(x)  gamma.test.ML(x, beta = 1.8)
...
mle <- function(x)  ML.inversegamma(x)
left.bound <- 0; right.bound <- Inf; theta <- c(alpha,beta); quant <- 2.3
test <- function(x) inversegamma.test.ML(x)
test <- function(x) inversegamma.test.ML(x, alpha = 3.45)
test <- function(x) inversegamma.test.ML(x, beta = 5.45)
...
mle <- function(x)  ML.betaprime(x) 
left.bound <- 0; right.bound <- Inf; theta <- c(alpha, beta); quant <- 1.3
...
mle <- function(x)  ML.Lomax(x)
left.bound <- 0; right.bound <- Inf; theta <- c(alpha, sigma); quant <- 2.3
test <- function(x)  Lomax.test.ML(x)

# Nakagami distribution
alpha <- 3.45; omega <- 5.45
dens <- function(x) dNakagami(x, alpha, omega)
cdf <- function(x) pNakagami(x, alpha, omega)
gen <- function(n) rNakagami(n, alpha, omega)
mle <- function(x)  ML.Nakagami(x)
left.bound <- 0; right.bound <- Inf; theta <- c(alpha,omega); quant <- 2.3
test <- function(x) Nakagami.test.ML(x)

# inverse-Gaussian
mu <- 5.45; lambda <- 1.45
dens <- function(x) dinvgauss(x, mean = mu, shape = lambda)
cdf  <- function(x) pinvgauss(x, mean = mu, shape = lambda)
gen <- function(n) rinvgauss(n, mean = mu, shape = lambda)
mle <- function(x)  ML.inversegaussian(x) 
left.bound <- 0; right.bound <- Inf; theta <- c(mu, lambda); quant <- 3
...
mle <- function(x)  ML.halfEPD(x)
mm <- function(x)  MM.halfEPD(x, lambda)
left.bound <- 0; right.bound <- Inf; theta <- sigma; quant <- sigma * 1.5
test <- function(x)  halfEPD.test.ML(x)
test <- function(x)  halfEPD.test.ML(x, lambda)
test <- function(x)  halfEPD.test.MM(x, lambda)

# exponential
beta <- 2.3
dens <- function(x) dexp(x, rate = 1 / beta)
cdf  <- function(x) pexp(x, rate = 1 / beta)
gen <- function(n) rexp(n, rate = 1 / beta) 
mle <- function(x)  ML.exp(x)
left.bound <- 0; right.bound <- Inf; theta <- beta; quant <- beta * 1.5
...
mle <- function(x)  ML.halfnormal(x)
mm <- function(x)  MM.halfnormal(x)
left.bound <- 0; right.bound <- Inf; theta <- delta; quant <- delta * 1.5
...
mle <- function(x)  ML.Rayleigh(x)
mm <- function(x)  MM.Rayleigh(x)
left.bound <- 0; right.bound <- Inf; theta <- delta; quant <- delta * 1.5
...
mle <- function(x)  ML.Maxwell(x)
mm <- function(x)  MM.Maxwell(x)
left.bound <- 0; right.bound <- Inf; theta <- delta; quant <- delta * 1.5
...
mle <- function(x)  ML.chisquared(x)
mm <- function(x)  MM.chisquared(x)
left.bound <- 0; right.bound <- Inf; theta <- k; quant <- 2.3
test <- function(x)  chisquared.test.ML(x)
test <- function(x)  chisquared.test.MM(x)

### Distributions on (lambda, infinity)

#### Pareto (type 1) distribution
alpha <- 9.3; lambda <- 3.4
dens <- function(x) dPareto(x, alpha, lambda)
cdf  <- function(x) pPareto(x, alpha, lambda)
gen <- function(n) rPareto(n, alpha, lambda) 
mle <- function(x)  ML.Pareto(x, lambda)
left.bound <- lambda; right.bound <- Inf; theta <- alpha; quant <- lambda + 1.5 / alpha
test <- function(x) Pareto.test.ML(x, lambda)
...
gen <- function(n)  rbeta(x, alpha, beta)
mle <- function(x)  ML.beta(x) 
left.bound <- 0; right.bound <- 1; theta <- c(alpha, beta); quant <- .678
...
mle <- function(x)  ML.Kumaraswamy(x) 
left.bound <- 0; right.bound <- 1; theta <- c(alpha, beta); quant <- .678
...
res <- apply(cbind(quant)/100, 1, g) * 100
plot(quant, res, type = 'l', lwd = 2); abline(a=0, b=1, col = 'red', lwd = 2, lty = 2)
plot(quant, (res - quant)); abline(h = 0)
round(cbind(quant, res), 1)

# ====================================================================================
# Figure 1, plot of cos and sin
# ====================================================================================
...
#     ylab = expression(paste("cos(2",pi,"u) or sin(2",pi,"u)")), xaxt = 'n', yaxt = 'n')
...
#title(ylab=expression(paste("cos(2",pi,"u) or sin(2",pi,"u)")), line=1.3, cex.lab=1.2)
...
# ====================================================================================
# First example, local alternative
# H0: gamma(lambda, beta) = GG(lambda, beta, rho=1) vs 
# H1n: local alternative GG(lambda, beta, rho \ne 1)
# ====================================================================================
...
# ====================================================================================
# Second example, Local alternative 
# H0: Weibull(beta,rho) = GG(1, beta, rho)
# H1n: local alternative GG(lambda \ne 1, beta, rho)
# ====================================================================================
...
# ====================================================================================
# Third example, Local alternative 
# H0: EPD(lambda, mu, sigma) = APD(lambda, 1/2, lambda, mu, sigma)
# H1n: local alternative APD(lambda, alpha, rho, mu, sigma), (alpha.rho) \ne (1/2,lambda)
# ====================================================================================
...
# Construction of the left plot : Asymptotic power curves of the modified score goodness-of-fit tests for the exponential power distribution, 
# using maximum likelihood (ML) versus method of moments (MM) estimators, under local alternatives 
# as a function of delta1 for a fixed delta2=0 . The auxiliary parameter value is lambda=1.5 and the nominal significance level is alpha=0.05
...
# Construction of the right plot: Asymptotic power curves of the modified score goodness-of-fit tests for the exponential power distribution, 
# using maximum likelihood (ML) versus method of moments (MM) estimators, under local alternatives 
# as a function of delta2 for a fixed delta1=0 . The auxiliary parameter value is lambda=1.5 and the nominal significance level is alpha=0.05
...
ana[[1]] <- c(lambda.est, mu.hat, sigma.hat); ana[[1]]
